...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ARCHIVE.COMMON.Entities.Client", b =>
                {
                    ...
                    b.Property<int?>("OCRQuota")
                        .HasColumnType("int");

                    b.Property<int?>("OCRUsed")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ARCHIVE.COMMON.Entities.EmailQueue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ARCHIVE.COMMON.Entities.EmailQueueDocFile", b =>
                {
                    b.Property<long>("EmailQueueId")
                        .HasColumnType("bigint");

                    b.Property<long>("DocFileId")
                        .HasColumnType("bigint");

                    b.HasKey("EmailQueueId", "DocFileId");

                    b.HasIndex("DocFileId");

                    b.ToTable("EmailQueueDocFile");
                });
            ...
            modelBuilder.Entity("ARCHIVE.COMMON.Entities.EmailQueueDocFile", b =>
                {
                    b.HasOne("ARCHIVE.COMMON.Entities.DocFile", "DocFile")
                        .WithMany()
                        .HasForeignKey("DocFileId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ARCHIVE.COMMON.Entities.EmailQueue", "EmailQueue")
                        .WithMany("EmailQueueDocFiles")
